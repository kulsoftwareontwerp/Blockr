...
public class ProgramAreaTest {
	...
	public void setUp() throws Exception {
		...
		testActionShapeWithZeroCoordinate = Mockito.spy(new ActionShape("1",
				moveForward, zeroCoordinate));
		testActionShapeOutOfBoundsCoordinate = Mockito.spy(new ActionShape("0", moveForward, outOfBoundsCoordinate));
		testActionShapeInBoundsCoordinate = Mockito.spy(new ActionShape("0", moveForward, inBoundsCoordinate));

		testControlShape = Mockito.spy(new ControlShape("10", BlockType.IF, inBoundsCoordinate));
		testControlShapeWhile = Mockito.spy(new ControlShape("10", BlockType.WHILE, inBoundsCoordinate));
		testControlShapeOOB = Mockito.spy(new ControlShape("11", BlockType.IF, outOfBoundsCoordinate));
	...
	public void testGetShapeById_Present(){
		...
		assertTrue(programArea.getShapeById("0").equals(testActionShape));
	}
